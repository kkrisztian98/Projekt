...
<body>
<script src="foglalasT.js"></script>
<?php
...
<div class="alap">
    ...
    <div class="jobbadmin">
        ...
        <form id="data" method="post" onsubmit="return CheckData()" onchange="CheckData2()">
            <label for="termek">Adja meg a törölni kivánt foglalás</label>
            <br>
            <span class="error" id="errt"> </span>
            <br>
            <select id="date" name="date">
                <option value="">-Foglalás-</option>
                <?php
                ...
                foreach ($results as $result) {
                    echo "<option value='{$result['id']}'>{$result['datum']}</option>";
                }
                ?>
            </select>
